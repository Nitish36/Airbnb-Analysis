...
def generate_data():
    ...
    # Generate data
    for _ in range(500):  # You can change the number of data points as needed
...
def write_df(**kwargs):
    ...
    TAB_NAME = 'Content'
    credentialsPath = os.path.expanduser("/home/nineleaps/airflow/dags/diamond-analysis-ac6758ca1ace.json")
